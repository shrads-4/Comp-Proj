...
def main(username):
    ...
    ImgList = [pg.image.load('TutorialImages\\1.png'), pg.image.load('TutorialImages\\2.png'), pg.image.load('TutorialImages\\3.png'), pg.image.load('TutorialImages\\4.png'), pg.image.load('TutorialImages\\5.png'), pg.image.load(
        'TutorialImages\\6.png'), pg.image.load('TutorialImages\\7.png'), pg.image.load('TutorialImages\\8.png'), pg.image.load('TutorialImages\\9.png'), pg.image.load('TutorialImages\\10.png'), pg.image.load('TutorialImages\\11.png')]
    while not done:
