import pygame as pg, os, run, mysql.connector, time, user_details, Leaderboard, tutorial
...
def main(username):
    ...
    def showScore(username):
        ...
        if con.is_connected():
            try:
                ...
                showError('High Score: '+str(high_score), screen,
                          x=290, y=300, color=(0, 0, 0), size=35)
    ...
    while not done:
        ...
        screen.blit(font.render('Welcome to Brain Rush!!!',
                                True, (0, 0, 0)), (75, 20))
